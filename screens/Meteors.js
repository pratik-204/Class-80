...
import { Text, View, Alert ,StyleSheet , SafeAreaView , FlatList , Image , ImageBackground, Dimensions , StatusBar , Platform } from 'react-native';
...
export default class MeteorScreen extends Component {
    ...
    getMeteors=()=>{
        axios
        .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=417jwXHzO7NKpemK6o1FDseX18hPPHqhBvXFfsw4")
        .then(response=>{
                ...
                <ImageBackground source={bg_img} style={styles.backgroundImage}>
                    ...
                    <View style={styles.gifContainer}>
                            ...
                            <View>
                                ...
                                <Text style={[styles.cardText,{marginTop:5,marginLeft:50}]}>
                                    Missing Earth By  - {item.close_approach_data[0].distance.kilometers}
                                </Text>
                            </View>
                    </View>
